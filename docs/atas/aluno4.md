...
| 09/03 - 15/03 | APIs e Web Services - Unidade 1 | ✅ | Realização do estudo do microfundamento e desenvolvimento da API dos serviços de cadastro, atualização e exclusão de pets e vacinas, além da criação conjunta com o Rafael da API de clínica e da execução dos testes para documentação. | Realização do estudo do microfundamento e desenvolvimento da API dos serviços de cadastro, atualização e exclusão de pets e vacinas, além da criação conjunta com o Rafael da API de clínica e da execução dos testes para documentação. |
